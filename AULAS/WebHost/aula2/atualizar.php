...
<body>
   ...
   <form method="post" action="update_n.php" name="dados" onSubmit="return enviardados();">
      ...
      <table width="588" border="0" align="center">
          <tr>
            ...
            <td width="460">
               <input name="id" type="text" class="formbutton" id="id" size="10" maxlength="40">
            </td>
         </tr>
         ...
         <tr>
            <td height="22"></td>
            <td>
               <input name="Submit" type="submit" class="formobjects" value="Atualizar">
